#!/bin/bash
#
# Taken from the article at the following URL
# https://www.getpagespeed.com/server-setup/clear-disk-space-centos
#
# To use, simple run the following command
# curl -Ls https://raw.githubusercontent.com/jgiambona/linux-scripts/master/clean-centos-disk-space | sudo bash
#
