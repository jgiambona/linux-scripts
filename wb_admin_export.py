# Edited by Jason to maintain compatibility with older versions of MySQL
# for exporting in MySQL Workbench
# As of Apr 6 2022 this file should replace the one located in
...
#        refresh_thread.run()
    ...
    def start(self):
        ...
        #if get_mysqldump_version() > Version(8, 0, 2) and self.owner.ctrl_be.target_version < Version(8, 0, 0) else False
